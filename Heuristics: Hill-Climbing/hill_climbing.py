...
def hill_climbing(init_timetable):
...
cnt = 1
def iterated_hill_climbing(num_of_inits):
...
solution, score, candidate_scores = iterated_hill_climbing(10)
